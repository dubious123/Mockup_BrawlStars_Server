...
public static partial class sMathf
{
	...
	public static sfloat Min(sfloat val1, sfloat val2)
	{
		...
		return val1.IsNegative() ? val1 : val2;
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static sfloat Sign(sfloat f)
	{
		return (f >= sfloat.Zero) ? sfloat.One : (sfloat)(-1f);
	}
	...
	internal static sfloat Abs(sfloat sf)
	{
		return sfloat.FromRaw(sf.RawValue & 0x7fff_ffff);
	}
}
